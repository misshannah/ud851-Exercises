...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String QUERY_URL_STRING = "query";
    // DONE (2) Create a static final key to store the search's raw JSON
    public static final String SEARCH_JSON_RESULTS = "results";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            String queryUrl = savedInstanceState.getString(QUERY_URL_STRING);
            String jsonReults = savedInstanceState.getString(SEARCH_JSON_RESULTS);

            mUrlDisplayTextView.setText(queryUrl);
            mSearchResultsTextView.setText(jsonReults);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(QUERY_URL_STRING,queryUrl);

        String jsonReults = mSearchResultsTextView.getText().toString();
        outState.putString(SEARCH_JSON_RESULTS,jsonReults);
    }
